namespace MovInfoService_CMD.MODEL
{
    ...
    public partial class tbltodo
    {
        ...
        public int iRecordState { get; set; }
        ...
        public float rCoverLenght { get; set; }
        ...
        public int iStackQuantity { get; set; }

        public long dQuantityToProduce { get; set; }

        public long dQuantityToProduceOriginal { get; set; }

        public long dQuantityProduced { get; set; }

        public int numRecipeWikoma { get; set; }

        public int iCodHoney { get; set; }
        ...
        public int iCoverUpMaterial { get; set; }

        public int iCoverDwMaterial { get; set; }
        ...
        [StringLength(50)]
        public string Wik_Name { get; set; }

        public float? Wik_Speed { get; set; }

        public float? Wik_Temp1 { get; set; }

        public float? Wik_Temp2 { get; set; }

        public float? Wik_Temp3 { get; set; }

        public float? Wik_Temp4 { get; set; }

        public float? Wik_TempHeat { get; set; }

        public float? Wik_PaperWidth { get; set; }

        public float? Wik_PaperHeightRaw { get; set; }

        public float? Wik_GuidesPos { get; set; }

        public float? Wik_PaperBelt1 { get; set; }

        public float? Wik_PaperBelt2 { get; set; }

        public float? Wik_PaperBelt3 { get; set; }

        public float? Wik_PaperBelt4 { get; set; }

        public float? Wik_PaperBelt5 { get; set; }

        public float? Wik_PaperBelt6 { get; set; }

        public float? Wik_PaperBelt7 { get; set; }

        public float? Wik_PaperBelt8 { get; set; }

        public float? Wik_M31wspSpeed { get; set; }

        public float? Wik_M1posOffset { get; set; }

        public float? Wik_M32wspSpeed { get; set; }

        public float? Wik_M2posOffeset { get; set; }

        public float? Wik_M3posOffset { get; set; }

        public float? Wik_M15posOffset { get; set; }

        public float? Wik_PaperHeight { get; set; }
